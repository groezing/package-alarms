...
|--------------------|-------------|
| __ce_....          | ce_functions input argument   | 
| __ce_headers       | ce_header is a copy of the HTTP request header   |
...
#### Args parameter set by Code Engine function's service (__ce_*)  
